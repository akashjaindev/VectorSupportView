...
public class VectorSwitchCompat extends SwitchCompat {
    private ColorStateList mTint;
    public VectorSwitchCompat(Context context) {
        super(context, null);
    }

    public VectorSwitchCompat(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.switchStyle);
    }

    public VectorSwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
