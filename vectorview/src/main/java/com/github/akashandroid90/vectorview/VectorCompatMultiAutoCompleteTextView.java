...
public class VectorCompatMultiAutoCompleteTextView extends AppCompatMultiAutoCompleteTextView {
    private ColorStateList mTint;
    public VectorCompatMultiAutoCompleteTextView(Context context) {
        super(context, null);
    }

    public VectorCompatMultiAutoCompleteTextView(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.autoCompleteTextViewStyle);
    }

    public VectorCompatMultiAutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr) {
