...
public class VectorCompatCheckBox extends AppCompatCheckBox {
    private ColorStateList mTint;
    public VectorCompatCheckBox(Context context) {
        super(context, null);
    }

    public VectorCompatCheckBox(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.checkboxStyle);
    }

    public VectorCompatCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
