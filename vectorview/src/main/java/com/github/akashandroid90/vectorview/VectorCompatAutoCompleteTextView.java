...
public class VectorCompatAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    private ColorStateList mTint;
    public VectorCompatAutoCompleteTextView(Context context) {
        this(context, null);
    }

    public VectorCompatAutoCompleteTextView(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.autoCompleteTextViewStyle);
    }

    public VectorCompatAutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr) {
